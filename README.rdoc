...
Simple filewatcher. Monitors changes in the filesystem by polling. Gem has no dependencies.
...
The environment variable $FILENAME is available in the shell command argument. On unix like systems the command
